...
import {
  filipJakobssonScout as scout,
  type FilipSpiderAxis,
} from "@/lib/filipJakobssonScoutData";
...
function SpiderChart({ axes }: { axes: readonly FilipSpiderAxis[] }) {
  const n = axes.length;
  ...
  return (
    <svg
      ...
      role="img"
      aria-label="Spindeldiagram – Filip Jakobsson U19 2026"
    >
      {rings.map((ring) => (
        <polygon
          key={ring}
...
export function FilipJakobssonScoutDashboard() {
        ...
        <div className="mx-auto max-w-6xl px-4 py-8">
          ...
          <div className="mt-4 flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
            <div>
              ...
              >
                A-truppens bänk · GAIS · U19-profil
              </p>
      ...
      <main className="mx-auto max-w-6xl space-y-8 px-4 py-8">
        ...
        <section className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
          ...
          <div className="rounded-2xl border border-slate-700/60 bg-slate-900/70 p-5 md:p-6">
            ...
            <p className="mt-1 text-xs text-slate-400">
              Kvalitetsranking mot övriga U19-mittfältare
            </p>
        ...
        <section className="rounded-2xl border border-slate-700/60 bg-slate-900/70 p-5 md:p-6">
          ...
          <p className="mt-1 text-xs text-slate-400">
            Topprankade enskilda KPI:er (per 90) i Allsvenskan U19
          </p>
