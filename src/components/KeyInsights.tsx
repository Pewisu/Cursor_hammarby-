...
const iconMap: Record<string, { icon: string; gradient: string }> = {
  tactical: { icon: "🎯", gradient: "from-red-500/20 to-orange-500/20" },
  possession: { icon: "⚽", gradient: "from-blue-500/20 to-cyan-500/20" },
  efficiency: { icon: "📊", gradient: "from-purple-500/20 to-pink-500/20" },
  passing: { icon: "🔄", gradient: "from-green-500/20 to-emerald-500/20" },
  defensive: { icon: "🧤", gradient: "from-indigo-500/20 to-blue-500/20" },
  discipline: { icon: "🟡", gradient: "from-yellow-500/20 to-amber-500/20" },
};
