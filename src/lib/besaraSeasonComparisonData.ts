...
export const besaraBasicStats: BesaraBasicStats[] = [
  {
    ...
    assistsPerNinety: parseFloat((3 / (2715 / 90)).toFixed(2)),
    goalsPlusAssistsPerNinety: parseFloat((20 / (2715 / 90)).toFixed(2)),
  },
  {
    season: "2026",
    minutesPlayed: 1147,
...
export const bolldataStats2025: BolldataStats = {
  ...
  points: 20,
  pointsPercent: 21.1,
  pointsPerNinety: 0.66,
  goalsPerNinety: 0.56,
  assistsPerNinety: 0.10,
  xG: 11.85,
  xA: 4.25,
  xP: 16.10,
  xGPerNinety: 0.39,
...
export const seasonNarratives: SeasonNarrative[] = [
  {
    ...
    summary:
      "Besara spelade hela 2025 som en av ligans mest produktiva spelare rent målmässigt. 17 mål och 3 assist på 30 matcher – 20 G+A totalt. Placerade sig i topp 3 av 119 jämförbara spelare i Twelve för np Mål. Skapa för lagkamrater och assist-statistiken var däremot klart lägre än 2026.",
...
export const keyInsights: string[] = [
  "Mål/90 sjönk från 0,56 till 0,39 – men Assist/90 steg från 0,10 till 0,39. Rollbyte från finisher till spelstartare.",
  "G+A/90 steg från 0,66 (2025) till 0,78 (2026) – mer total offensiv output per minut 2026.",
  ...
  "Rank 'Skapa för lagkamrater': 39/119 (2025) → 4/73 (2026). Assist/90 tredubblades: 0,10 → 0,39.",
];
