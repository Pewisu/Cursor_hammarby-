...
export const hammarbyAgePlayingTimeSeasons: HammarbyAgePlayingTimeSeason[] = [
  ...
  },
  {
    ...
    matches: 14,
    totalAvailableMinutes: 14810,
    sourceUrl: "https://bolldata.se/talangdata?season_name=2026#team-playing-time-under-21",
    thresholds: {
      u23: { minutes: 6554, percentage: 44.3, rank: 6, teams: 16 },
      u22: { minutes: 4649, percentage: 31.4, rank: 6, teams: 16 },
      u21: { minutes: 1675, percentage: 11.3, rank: 14, teams: 16 },
      u20: { minutes: 583, percentage: 3.9, rank: 13, teams: 16 },
      u19: { minutes: 12, percentage: 0.1, rank: 14, teams: 16 },
      u18: { minutes: 8, percentage: 0.1, rank: 11, teams: 16 },
    },
    seniorBreakdown: {
      peak: { minutes: 4838, ageRange: "24-29" },
      twilight: { minutes: 3418, ageRange: "30+" },
    },
    averageAge: {
      totalSquad: 23.9,
      startingEleven: 24.8,
