...
export const upcomingOpponents: UpcomingOpponentReport[] = [
  {
    ...
    mobileTakeaways: [
      "Hammarby är 2:a i tabellen (14p), Mjällby 4:a (13p) efter 7 omgångar.",
    ...
    quickStatusCards: [
      ...
      },
      {
        ...
        body: "4:a i tabellen (13p), 12-8 i mål. Jämna prestationer, starka i spelvändningar och boxattacker.",
        tone: "amber",
      },
      {
        title: "Viktig period",
