...
export const upcomingOpponents: UpcomingOpponentReport[] = [
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    dateLabel: "Augusti 2026 · Tele2 Arena · Twelve opposition report (Ekstraklasa 26/27, 2 matcher)",
    venueLabel: "Hemma · Tele2 Arena",
    oneLineSummary:
      "Raków Częstochowa spelar 3-4-3 med balanserad press (PPDA 5,92), korta uppbyggnader från målvakt (100%) och korsningsdominerat anfall via vänsterkanten (0,49 xG/match från vänster halvzon). Defensivt sårbara på VÄNSTER kant (0,41 xT/match insläppt). Likvärdig truppstyrka – ett jämt möte med tydliga angreppspunkter.",
    introStats: [
      { label: "Formation (Ekstraklasa 26/27)", value: "3-4-3 · 100% speltid", tone: "blue" },
      { label: "PPDA (Twelve)", value: "5,92 · Ekstraklasa 26/27", tone: "amber" },
      { label: "Def. action height", value: "39,47m · Medelhögt block", tone: "blue" },
      { label: "Playoff", value: "Vinnaren → UECL-grupp", tone: "emerald" },
    ],
    mobileTakeaways: [
      "Formation: 3-4-3 (100% speltid) med tre mittbackar, två wingbackar (Otieno VWB, Ameyaw/Jean Carlos HWB) och tre forwards.",
      "PPDA 5,92 – Raków pressar hyfsat bra för Ekstraklasa, men fortfarande klart under HIF:s 4,93.",
      "Anfaller via VÄNSTERKANTEN: vänster halvzon genererar 0,49 xG/match – deras absolut farligaste zon. HIF:s högerback är nyckeln defensivt.",
      "Defensiv svaghet: VÄNSTER kant (motståndarens perspektiv = HIF:s HÖGER attack). 0,41 xT/match insläppt från den sidan – HIF ska driva höger.",
      "Korsingsberoende: 48% av boxinträdena kommer via korsning. WB-par skapar inlägg – håll koll på Otieno (VWB) och Jean Carlos/Ameyaw (HWB).",
      "Bygger upp 100% från målvaktsutspark – press på deras keeper stör hela uppbyggnadsspelet.",
      "Källa: Twelve opposition report Ekstraklasa 2026/27 (2 matcher: 26 jul + 2 aug 2026)",
    ],
    dataSources: [
      "Twelve opposition report Raków Częstochowa – Ekstraklasa 2026/27 (2 matcher): https://reports.twelve.football/reports/opposition-report-rak%C3%B3w-cz%C4%99stochowa-PZYHtoZJoP.pdf",
    ...
    cupSpecial: {
      ...
      tacticalKeys: [
        ...
        "Attackera Raków:s VÄNSTRA kant (= HIF:s HÖGRA attack): 0,41 xT/match insläppt – deras tydligaste defensiva svaghet. Driva mot deras vänster wingback (Otieno) ger bäst chanslägen.",
        "Press på målvaktsutsparken: Raków bygger 100% från keeper – tidig press stör deras hela uppbyggnadssystem.",
        "Vakta deras vänster halvzon offensivt: 0,49 xG/match genererat från vänster halvzon. HIF:s högerback och -mitt måste täcka Tomasz Pieńko (LF) och vänster WB (Otieno) tätt.",
      ],
    },
    headToHead: {
      sampleSize: 0,
    ...
    trafficLightCards: [
      {
        metric: "Defensiv svaghet – VÄNSTER kant (Twelve · Ekstraklasa 26/27)",
        bigNumber: "0,41 xT/match",
        badge: "ATTACKERA HÖGER",
        color: "green",
        rankNote: "Högst insläppt xT av alla zoner · 0,24 xT höger kant · Central zon trygg",
        explanation:
          "Raków:s tydligaste defensiva svaghet är deras VÄNSTER kant – motståndare skapar 0,41 xT/match via den sidan, klart mer än alla andra zoner. HIF:s HÖGER attack (Abraham, Skoglund eller höger WB i 3-4-3-kontexten) bör driva ner den sidan konsekvent. Central zon och HÖGERkant är tryggare för Raków defensivt.",
        podcastComment:
          "Deras vänsterkant läcker. 0,41 xT per match, klart mest av alla zoner. Vi ska köra ner den sidan hela matchen – in mot boxen från höger är vår bästa attackväg.",
      },
      {
        metric: "Korsningsberoende anfall (Twelve · Ekstraklasa 26/27)",
        bigNumber: "48%",
        badge: "INLÄGG DOMINERAR",
        color: "red",
        rankNote: "48% av boxinträden via korsning · Carries bara 8% · WB-par avgörande",
        explanation:
          "Raków tar sig in i boxen primärt via korsningar (48%) – inte via bollbärande (8%). Deras wingbackar (Otieno VWB, Jean Carlos/Ameyaw HWB) genererar inlägg och skapar deras farligaste chanser: 1,04 xG/match från sexmeterszonen efter inlägg in i boxen. HIF:s backfyra måste täcka WB-löpningarna och ta bort inläggsytorna. Skapar Raków lediga inlägg från kanterna är de farliga.",
        podcastComment:
          "De lever på korsningar – nästan hälften av alla boxinträden via inlägg. Vi måste stänga deras WBs. Låter vi Otieno och Jean Carlos komma in fritt från kanterna med bollen är de direkt farliga.",
      },
      {
        metric: "Pressing (Twelve · PPDA 5,92 · Ekstraklasa 26/27)",
        bigNumber: "PPDA 5,92",
        badge: "HYFSAD PRESS",
        color: "yellow",
        rankNote: "Defensiv action height 39,47m · Defensiv intensitet 5,84 · Genomsnittligt för Ekstraklasa",
        explanation:
          "Raków pressar hyfsad (PPDA 5,92) men väljer strategiskt NÄR de pressas och faller ibland tillbaka snarare än att counterpressas. Defensiv action height 39,47m är medelhög – inte ett extremt högt pressande lag. HIF:s PPDA 4,93 är klart skarpare, men Raków är inte en enkel offensiv push-over. De är organiserade när de väljer att sluta pressa och falla i ett kompakt block. Skapa snabba kombinationer IGENOM deras press.",
        podcastComment:
          "De pressar hyfsat – PPDA under 6 är faktiskt rätt bra för Ekstraklasa. Men de väljer sina pressmoment strategiskt och faller tillbaka. Vi är fortfarande klart bättre på att pressa, men vi ska vara beredda på att möta ett disciplinerat block.",
      },
    ],
    quickStatusCards: [
      {
      ...
      {
        title: "Raków – aktuell form (Ekstraklasa 26/27)",
        body: "3-4-3 · PPDA 5,92 · Def. action height 39,47m. 2 matcher spelta i ny säsong: 1-2 hemma vs Wisła + 1-2 borta vs Śląsk. Balanserad press, vänsterdominerat anfall (0,49 xG/match vänster halvzon), korsningsberoende (48% boxinträden).",
        tone: "blue",
      },
      {
    ...
    opponentStyle: [
      "Formation 3-4-3 (100% speltid): tre mittbackar (Jean Carlos, Racovițan, Debohi/Tudor), två wingbackar (Otieno VWB, Ameyaw/Jean Carlos HWB), två centrala mittfältare (Repka, Kochergin) och tre forwards (Pieńko VF, Makuch/Emreli CF/HF).",
      "Balanserad press med strategiska defensiva transitioner – väljer NÄR de pressar och faller ibland tillbaka i ett organiserat block snarare än att alltid counter-pressa. PPDA 5,92, defensiv action height 39,47m.",
      "Bygger upp 100% via målvaktsutspark (kort/medellång uppbyggnad, under 32m). All initial uppbyggnad går igenom keepern – press på deras GK stör hela spelsystemet.",
      "Anfaller primärt via VÄNSTERKANTEN: vänster halvzon genererar 0,49 xG/match (klart mest av alla zoner). Tomasz Pieńko (LF) och Otieno (VWB) är drivkrafterna till vänster.",
      "Korsningsberoende: 48% av boxinträdena via korsning (bara 8% via bollbärande). Skapar chanser inne i boxen – sexmeterszonen genererar 1,04 xG/match (5 skott).",
      "Defensivt sårbar på VÄNSTER kant: 0,41 xT/match insläppt från vänster sida – HIF ska attackera via sin HÖGER kant konsekvent. Centrala zonen och höger kant är tryggare för dem defensivt.",
    ],
    styleProfile: [
      {
        label: "Press (Ekstraklasa 26/27, Twelve)",
        value: "PPDA 5,92 · Def. intensitet 5,84 · DAH 39,47m",
        score: 68,
        explanation:
          "Raków pressar hyfsad bra (PPDA 5,92) – bättre än ett genomsnittligt Ekstraklasa-lag. De väljer strategiskt när de aktiverar pressen och faller ibland tillbaka i ett kompakt block istället för att alltid counter-pressa. Defensiv action height 39,47m är medelhögt – inte extrem höjd, inte djupt. HIF:s 4,93 är skarpare, men Raków kan inte köras igenom på press ensam.",
      },
      {
        label: "Vänsterdominerat anfall (Twelve · 26/27)",
        value: "0,49 xG/match vänster halvzon · 48% box entries via korsning",
        score: 72,
        explanation:
          "Raków:s starkaste offensiva kanal är vänster halvzon – 0,49 xG/match genererat där, nästan dubbelt mot näst farligaste zonen. Tomasz Pieńko (LF) och Otieno (VWB) driver den sidan. De är korsningsberoende (48% av boxinträdena via inlägg), inte bärarberoende (8%). HIF:s högerback och mittfältare måste täcka vänster halvzon tätt.",
      },
      {
        label: "Defensiv sårbarhet – vänster kant",
        value: "0,41 xT/match insläppt · Tydligaste defensiva svaghet",
        score: 30,
        explanation:
          "Raków:s vänster kant är deras tydligaste defensiva svaghet – motståndare genererar 0,41 xT/match via den sidan. I jämförelse: höger kant 0,24 xT, centrala zoner tryggare. HIF ska attackera konsekvent via sin HÖGER kant (Hammarby:s höger = Raków:s vänster). Ytan bakom Otieno (VWB) och framför vänster CB är guldzon.",
      },
      {
        label: "Korsningsberoende boxpenetration",
        value: "48% box entries via korsning · Sexmeterszonen 1,04 xG/match",
        score: 65,
        explanation:
          "Raków bygger chanser via inlägg snarare än genombrott – 48% av boxinträdena via korsning, bara 8% via bollbärande. De är farligast från sexmeterszonen (1,04 xG/match, 5 skott). HIF:s backfyra måste stänga inläggsytorna för WBs och behålla kompaktheten inne i boxen – avslutar Raków från nära håll är de effektiva.",
      },
      {
        label: "Uppbyggnad från GK (Twelve · 26/27)",
        value: "100% uppbyggnad via GK-utspark · Kortspel dominant",
        score: 60,
        explanation:
          "Raków bygger ALLTID via målvaktsutspark – 100% av deras uppbyggnad startar med keepern (kort/medellång boll under 32m). Det betyder att press på deras GK-utsparkar stör hela spelsystemet. HIF:s höga press (1:a Allsvenskan) bör aktiveras maximalt på Raków:s keepers utsparkar för att vinna bollar högt och i farliga positioner.",
      },
      {
        label: "Defensiv transition (Twelve · 26/27)",
        value: "DAT 6,88s (att. half) · 30% opp. final third entries",
        score: 58,
        explanation:
          "Raków:s defensiva transition är genomsnittlig – tid till defensiv aktion 6,88s efter förlust i anfallshalvan. Motståndare når deras sista tredjedel inom 10s i 30% av fallen efter ombyten. De är sårbara i höger halvzon och centralt när HIF vinner bollen högt. HIF:s snabba transitional-press (1:a Allsvenskan) kan exploatera detta fönster direkt.",
      },
    ],
    spiderComparison: [
      {
        label: "np xG / match",
        hammarbyValue: "~2,19",
        opponentValue: "~2,16 (2 matcher)",
        hammarbyScore: 100,
        opponentScore: 99,
        note: "Extremt jämnt i xG-produktion. Raków skapar 1,04+0,73+0,04+0,22+0,13 xG/match i anfall = ~2,16. Riktigt jämt möte xG-mässigt.",
      },
      {
        ...
        hammarbyScore: 100,
        opponentScore: 83,
        note: "HIF pressar hårdare men skillnaden är mindre än förväntat. Raków PPDA 5,92 är bra för Ekstraklasa – de pressas men är organiserade.",
      },
      {
        label: "Defensiv action height",
        hammarbyValue: "~44,7m (1:a Allsvenskan)",
        opponentValue: "39,47m",
        hammarbyScore: 100,
        opponentScore: 70,
        note: "HIF pressar högt (44,7m). Raków medelhög defensiv höjd (39,47m) – de tvingas bakåt mot HIF:s press.",
      },
      {
        label: "Offensiv vänsterkanal",
        hammarbyValue: "hög",
        opponentValue: "0,49 xG/match (vänster halvzon)",
        hammarbyScore: 85,
        opponentScore: 80,
        note: "Raków är farliga via sin vänster halvzon (0,49 xG/match). HIF:s högerback-sektor måste täcka Pieńko och Otieno tätt.",
      },
      {
        label: "Korsningsfarlighet",
        hammarbyValue: "medel",
        opponentValue: "48% box entries via korsning",
        hammarbyScore: 55,
        opponentScore: 75,
        note: "Raków är korsningsdominanta (48%) – ett av deras tydligaste vapen. HIF bör stänga inläggsytorna längs kanterna.",
      },
      {
        label: "Def. svaghet – vänster kant",
        hammarbyValue: "stark högerattack",
        opponentValue: "0,41 xT insläppt (svagaste zon)",
        hammarbyScore: 90,
        opponentScore: 30,
        note: "HIF ska utnyttja Raków:s defensiva vänsterkant. 0,41 xT/match insläppt = tydligaste svaghetszonen – HIF höger attack är nyckeln.",
      },
      {
        label: "Uppbyggnad via GK",
        hammarbyValue: "varierat",
        opponentValue: "100% via GK-utspark",
        hammarbyScore: 75,
        opponentScore: 60,
        note: "Raków bygger ALLTID via keepern – HIF:s press mot deras GK-utsparkar stör hela uppbyggnadssystemet.",
      },
      {
        label: "Def. transition (snabbhet)",
        hammarbyValue: "snabb",
        opponentValue: "6,88s (att. half) · 30% final third entries",
        hammarbyScore: 85,
        opponentScore: 55,
        note: "Raków har genomsnittlig defensiv transition – 30% av motståndares ombyten når deras sista tredjedel inom 10s. HIF kan exploatera detta fönster.",
      },
    ],
    rankedMetrics: [
      {
        ...
        hammarbyRank: "1:a i Allsvenskan",
        opponentValue: "5,92",
        opponentRank: "Hyfsat i Ekstraklasa 26/27",
        note: "HIF pressar hårdare men Raków är inte ett svagt pressande lag. Skillnaden är real men inte extrem.",
      },
      {
        label: "Def. action height (Twelve · m)",
        hammarbyValue: "~44,7m",
        hammarbyRank: "1:a i Allsvenskan",
        opponentValue: "39,47m",
        opponentRank: "Medelhögt i Ekstraklasa",
        note: "HIF pressar 5m högre upp på planen. Raków tvingas bakåt mot HIF:s höga press.",
      },
      {
        label: "xG offensivt / match (Twelve · 26/27)",
        hammarbyValue: "~2,19",
        hammarbyRank: "1:a i Allsvenskan",
        opponentValue: "~2,16",
        opponentRank: "Hög för Ekstraklasa",
        note: "Extremt jämnt! Raków skapar imponerande xG-mängd i sina 2 matcher. Offensivt jämt möte.",
      },
      {
        label: "Korsningar per final-third possession (Twelve)",
        hammarbyValue: "måttlig",
        hammarbyRank: "—",
        opponentValue: "0,45 korsningar",
        opponentRank: "Hög i Ekstraklasa 26/27",
        note: "Raków är korsningsorienterade (0,45/possession i sista tredjedelen) – HIF:s backfyra måste täcka inläggsytorna.",
      },
      {
        label: "Box entries från korsning (Twelve)",
        hammarbyValue: "måttlig",
        hammarbyRank: "—",
        opponentValue: "48%",
        opponentRank: "Hög i Ekstraklasa 26/27",
        note: "Raków:s primära angreppsmetod för att komma in i boxen. Stäng deras WB-inlägg.",
      },
      {
        label: "Opp. final-third entries inom 10s (def. transition)",
        hammarbyValue: "lågt insläppt",
        hammarbyRank: "Topp defensivt hemma",
        opponentValue: "30%",
        opponentRank: "Genomsnittligt Ekstraklasa",
        note: "30% av HIF:s ombyten når Raków:s sista tredjedel inom 10s – HIF:s snabba transitions exploaterar detta.",
      },
    ],
    goalWindows: [
      { window: "0–15'", hammarbyGoals: 4, opponentConcededGoals: 1 },
    ...
    goalTypeNotes: [
      {
        label: "Raków offensivt mönster (Twelve · Ekstraklasa 26/27)",
        value: "Vänster halvzon 0,49 xG/match · 48% box entries via korsning · 100% GK-uppbyggnad",
        interpretation:
          "Raków skapar sina bästa chanser via vänster halvzon (0,49 xG/match) – det är deras primära attackkanal. De bygger alltid upp via goalkeeper (100%) och korsningsorienterade (48% boxinträden via inlägg). Deras skott per final-third pass är 0,17 – hyfsad effektivitet. Sexmeterszonen genererar 1,04 xG/match när de väl kommer in nära. HIF:s höger sida och defensiv inläggshantering är avgörande.",
      },
      {
        label: "Raków defensivt mönster – insläppta (Twelve · 26/27)",
        value: "Vänster kant sårbar (0,41 xT insläppt) · Central zon trygg · Kors/corner-sårbarhet",
        interpretation:
          "Raków:s defensiva svaghet är tydlig: vänster kant (0,41 xT/match insläppt – klart högst av alla zoner). Rätt och central zon är tryggare för dem. De tillåter 34% av motståndares boxinträden via korsning och är sårbara från hörnor (corners till vänster och höger – 0,21 resp. 0,14 xG/match). HIF:s starka hörnspel (1:a Allsvenskan i hörnsaldo) kan vara matchavgörande.",
      },
      {
        label: "Attacking transition (Twelve · 26/27)",
        value: "1,04s till framåtpass efter återerövring · 66% första pass forward",
        interpretation:
          "Raków övergår snabbt efter bollåtervinning – 1,04 sekunder till första framåtpass. 66% av återvunna bollar spelas omedelbart framåt. 26% når sista tredjedelen inom 10s. De exploaterar centrala kanalen och vänster halvzon i sina snabba transitions. HIF:s defensiva linje måste stå kompakt och inte lämna djuputrymme bakom sig vid bollförlust.",
      },
      {
        label: "Hammarby hemma 2026",
        value: "22-5 · +17 GD (5V-1O-1F)",
        interpretation:
          "Tele2 Arena är en fästning – 22 gjorda och 5 insläppta på 7 hemmamatcher. Starkast hemma i hela Allsvenskan. I en europeisk playoff-tie är hemmamål extra värda – ett eller gärna två mål i Tele2 ger ett psykologiskt övertag inför returen i Częstochowa. Hammarby behöver ett mål eller mer – 0-0 ger Raków favorit-status i retur.",
      },
    ],
    playersToWatch: [
      {
    ...
    hammarbyPlan: {
      withBall: [
        "ATTACKERA RAKÓW:S VÄNSTER KANT (= HIF:s HÖGER): 0,41 xT/match insläppt – tydligaste defensiva svaghetszonen. HIF:s högeranfall (Abraham, Skoglund eller höger-WB i systemenliga positioner) ska driva konsekvent mot Raków:s VWB Otieno och vänster CB. Den ytan ger bäst chanser.",
        "Press på Raków:s GK-utsparkar: de bygger 100% via keepern. HIF:s höga press (PPDA 4,93, 1:a Allsvenskan) ska aktiveras maximalt på Raków:s målvakt och centerbbackspar – vinn bollar i deras uppbyggnadsfas och skapa snabba lägen nära boxen.",
        "Utnyttja hörnor: HIF +39 i hörnsaldo (1:a Allsvenskan). Raków insläpper xG från corners (0,21 xG/match vänster corner + 0,14 xG/match höger corner). Vältränade corner-rutiner kan vara matchavgörande i ett jämt playoff-möte.",
        "Sätt ett mål tidigt hemma – playoff-returen är i Częstochowa. Raków:s transitions (66% första pass forward, 1,04s till framåtpass) är farliga om de har ett mål att försvara. Ett tidigt hemma-mål ändrar spelbilden fundamentalt.",
      ],
      withoutBall: [
        "Vakta Raków:s VÄNSTER HALVZON offensivt (= HIF:s höger defensiv): 0,49 xG/match genererat därifrån är deras farligaste zon. HIF:s högerback och höger mittfältare måste täcka Pieńko (LF) och Otieno (VWB) tätt – hindra dem från att ta emot i halvzonen.",
        "Stäng inläggsytorna: Raków är korsningsberoende (48% boxinträden via korsning). HIF:s backfyra måste aktivt ta bort WB-inläggsytorna längs kanterna och stänga Otioneos och Jean Carlos/Ameyaws löpningar mot bylinjen.",
        "Press mot Repka och Kochergin (CMs): de driver Raków:s distributionsspel i 3-4-3. Tätt press mot deras mottagningar bakifrån stör uppbyggnaden – Raków bygger via GK och CMs, stryp det flödet.",
        "Kompakt boxkontroll defensivt: Raków är farligast från sexmeterszonen (1,04 xG/match) – de skapar sina bästa chanser med Makuch och Emreli inne i boxen efter inlägg. Strimlad markeringsdisciplin och tydliga boxansvarsroller vid varje inlägg.",
      ],
      matchManagement: [
        "Playoff = allt-eller-inget: vinst i Tele2 är det enda tillfredsställande resultatet. Raków:s form i Ekstraklasa (1-2 hemma vs Wisła, 1-2 borta vs Śląsk) visar att de är slagbara – de är inte ointagliga trots europeisk erfarenhet.",
        "Historisk chans: UECL-gruppspelet är Hammarbys första europeiska gruppspel någonsin. Tele2 Arena på en europeisk kväll med hemmapublik är Hammarbys starkaste kort – kanalisera den energin till ett aggressivt spel från första minut.",
        "Spelmodell-krocken: Raków spelar 3-4-3 med WBs och 3 CBs – HIF:s tresyfte i pressing ska riktas mot deras mittbacks och keeper. Ytterforward och WBs ska pressa brett och sätta WBs under press för att stänga deras korsningsvägar.",
        "Bortareturen i Częstochowa: med ett hemma-mål i bagaget är bortamatch mer hanterbar. Raków:s transitions-kapacitet (1,04s till framåtpass) innebär att HIF måste spela kompakt borta – men ett välförsvarsparat 1-0 eller 2-0 från Tele2 ger gott utgångsläge.",
      ],
    },
    spotlightKey:
      "Raków spelar 3-4-3 med PPDA 5,92 – bättre pressat än väntat men klart under HIF:s 4,93. Matchen avgörs av tre konkreta faktorer ur Twelve-rapporten: (1) HIF HÖGER KANT mot Raków:s defensiva svaghet: 0,41 xT/match insläppt längs Raków:s vänster kant – HIF:s högeranfall är den tydligaste angreppspunkten. (2) Corner-duellen: Raków insläpper 0,21+0,14 xG/match från corners, HIF leder Allsvenskan med +39 i hörnsaldo – set-pieces kan avgöra aggregat. (3) Vakta Raków:s VÄNSTER HALVZON offensivt: 0,49 xG/match genererat därifrån (Pieńko LF + Otieno VWB) – HIF:s högerback måste täcka den zonen tight hela matchen.",
    glossary: [
      {
        term: "PPDA (Passes Per Defensive Action, Twelve)",
        explanation:
          "Motståndarens passningar per defensiv aktion. Lägre = hårdare press. HIF 4,93 (1:a Allsvenskan). Raków 5,92 (Ekstraklasa 26/27, 2 matcher). Skillnad finns men Raków pressar hyfsat – inte ett svagt pressande lag.",
      },
      {
        term: "Defensive action height (Twelve · m)",
        explanation:
          "Genomsnittlig position (meter) för defensiva aktioner. Raków 39,47m – medelhögt block. HIF ~44,7m (1:a Allsvenskan). HIF pressar avsevärt högre upp – tvingar Raków att spela bakåt under press.",
      },
      {
        term: "xT (Expected Threat, Twelve)",
        explanation:
          "Sannolikhetsbaserat hot per passning/bollbärning. Raków insläpper 0,41 xT/match längs sin vänster kant (tydligaste defensiva svaghet). HIF ska konsekvent attackera via sin HÖGER kant för att maximera xT-hotet.",
      },
      {
        term: "Box entries from crosses % (Twelve)",
        explanation:
          "Andel boxinträden via korsning. Raków 48% – korsningsdominant attack via WBs. HIF:s backfyra ska stänga inläggsytorna och begränsa WBs Otieno och Jean Carlos/Ameyaw från fria korsningspositioner.",
      },
      {
        term: "3-4-3 (Raków:s formation)",
        explanation:
          "Tre mittbackar (Jean Carlos/Racovițan/Debohi), två wingbackar (Otieno VWB, Ameyaw/Jean Carlos HWB), två CMs (Repka 100%, Kochergin 68%), tre forwards (Pieńko LF, Makuch/Emreli S/RF). WBs är centrala i korsningsspelet.",
      },
      {
        term: "Buildup from goalkick % (Twelve)",
        explanation:
          "Raków 100% – ALL uppbyggnad sker via GK-utspark (kortspel, under 32m). Press på Raków:s keeper stör hela deras spelsystem. HIF:s press mot GK-utsparkar är ett direkt verktyg för att vinna bollar högt.",
      },
    ],
  },
];
