  ...
  { ...gaisRound18Report, hidden: true },
  {
    ...
    spiderComparison: [
      ...
      },
      {
        ...
        hammarbyScore: 100,
        opponentScore: 64,
        note: "HIF dominerar bollen. Kalmar (48%) har lägre bollinnehav än Häcken (52%). Accepterar att försvara djupt.",
      },
      {
        label: "Field tilt (%)",
        hammarbyValue: "~69%",
        ...
        hammarbyScore: 100,
        opponentScore: 44,
        note: "Hammarby dominerar sista tredjedelen totalt. Kalmar (49%) nära ligasnittet – mycket svagare än HIF.",
      },
      {
        label: "PPDA (press)",
        hammarbyValue: "4,90",
        ...
        hammarbyScore: 100,
        opponentScore: 42,
        note: "HIF pressar 40% hårdare. Kalmar (6,84) är passivare än Häcken (6,0) – lägre pressintensitet i ligan.",
      },
      {
