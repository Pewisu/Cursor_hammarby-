...
const PLAYERS_TO_WATCH = [
  ...
  },
  {
    ...
    pos: "YF/VY · Sverige",
    badge: "⚡ Snabb ytterspelare",
    stats: "Häckens primära vänsterytter – inläggsskytt",
    threat: "Häckens vänsterkant och primäre inläggsspelare. Håller ihop det ~42%-inläggsberoendet i praktiken. Snabb, direkt och tar tidiga inlägg in i boxen för Svanbäck och Sadiku.",
    counter: "HIF:s högerback måste ligga tight. Blockera inlägget innan det sätts in – dra honom tillbaka defensivt.",
    color: "border-orange-500/40 bg-orange-950/20",
  },
  {
    name: "Aboubacar Doumbia",
    pos: "MF · Guinea",
    badge: "🛡️ Defensiv ankare",
    stats: "Gick in som avbytare mot Kalmar – gult kort Ø15",
    threat: "Fysisk och aggressiv defensiv mittfältare. Stör Hammarbys uppbyggnadsspel och vinner luftdueller. Fick gult kort mot Kalmar – ett till och han är avstängd.",
    counter: "Pressa honom högt i uppspelet. Hans aggressivitet kan nyttjas – locka fram tacklingar.",
    color: "border-slate-500/40 bg-slate-800/30",
  },
  {
    name: "Harun Ibrahim",
    pos: "AM/MF · Sverige (lån Sharjah)",
    badge: "🆕 Debuterade från start Ø15",
    stats: "88 allsvenska matcher för GAIS (8 mål)",
    threat: "Ny i Häcken-systemet men välbekant i Allsvenskan. Teknisk och smart – söker halvrummet och kan vända snabbt.",
    counter: "Stäng halvrummen och hindra honom att vända med boll.",
