...
const DEFAULT_MATCH_ID = Number(process.env.MATCH_ID ?? "6529964");
const DEFAULT_MATCH_SLUG = process.env.MATCH_SLUG ?? "kalmar-ff-mot-hammarby";
const DEFAULT_BOLLDATA_MATCH_API_ID = Number(process.env.BOLLDATA_MATCH_API_ID ?? "7334");
